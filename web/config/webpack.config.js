...
module.exports = function(webpackEnv) {
  ...
  return {
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            // We intentionally do not hash the font files
            // so we can more easily preload them via
            // static path reference in index.html.
            {
              test: /\.(woff2)$/,
            ...
            // that fall through the other loaders.
            {
              ...
              exclude: [/\.(js|mjs|jsx|ts|tsx|woff2)$/, /\.html$/, /\.json$/],
              options: {
    ...
    plugins: [
      ...
      //   // rel: 'preload',
      //   // include: 'allAssets',
      //   // fileBlacklist: [/\.map/, /\.svg/, /\.jpg/, /\.png/, /\.txt/]
      // }),
